...
def _build_prompt(spec: dict, asset_map: dict) -> str:
    ...
    return (
        ...
        "BESPOKE Vite + React + TypeScript single-page application that delivers the "
        ...
        "(assets) — what each chapter teaches and which media it uses. It describes "
        "*behaviour and intent*, not a fixed component library. You have FULL creative "
        "freedom over the HOW: layout, navigation, styling, motion and the way each "
        "piece of content is presented. Build custom React components that match the "
        "spec's design intent — do not build a generic JSON renderer. Each page and "
        "interaction should feel purpose-built.\n\n"
        ...
        "types (including worked_example, code, embed), as long as no content is lost. "
        "Never produce thin or short chapters.\n"
