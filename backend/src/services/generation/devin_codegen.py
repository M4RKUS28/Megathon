...
def _build_prompt(spec: dict, asset_map: dict) -> str:
    ...
    return (
        ...
        "   or fetch real URLs yourself. Use every provided asset.\n"
        ...
        "6. **Audio assets** follow the same pattern: resolve `/resources/audio/…`\n"
        "   template_links through asset_map to get the audio file URL. Wire the\n"
        "   resolved URL into an `<audio>` element or player component.\n\n"
