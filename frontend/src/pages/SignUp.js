...
export function SignUpPage() {
    ...
    return (_jsx("div", { className: "flex h-screen items-center justify-center", children: _jsx("span", { className: "text-muted-foreground text-sm", children: "Redirecting to sign up\u2026" }) }));
}
