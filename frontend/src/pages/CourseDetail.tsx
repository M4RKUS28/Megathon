...
import type { CourseConceptChapter, CoursePlan, GenerationJobRecord, PlanChapter } from "@/lib/api";
...
export function CourseDetailPage() {
  ...
  const poll = (course ? BUSY_STATUSES.has(course.status) : true) || editBusy;
